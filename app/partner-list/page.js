  ...
  return (
    <main className="max-w-5xl mx-auto pt-28 pb-16 px-6 min-h-screen">
      <header className="mb-16 text-center md:text-left">
        ...
        <h1 className="font-bold text-5xl md:text-6xl bg-gradient-to-r from-pink-500 to-rose-600 bg-clip-text text-transparent font-mono tracking-tighter uppercase">
          Lista per lei
        </h1>
        <p className="text-slate-500 font-mono text-sm mt-4 max-w-md leading-relaxed">
          Sogni, piccoli pensieri e tutto ciò che la farebbe felice.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <button
          ...
          className="group relative border-2 border-dashed border-pink-200 hover:border-pink-500 transition-all rounded-[2.5rem] flex flex-col items-center justify-center p-8 min-h-[350px] bg-white/5 hover:bg-white/20"
        >
          ...
          >
            ...
            <div className="px-2 font-mono">
              ...
              <a
                ...
                className="mt-4 w-full flex items-center justify-center gap-2 py-3 bg-white border border-slate-200 text-slate-800 rounded-2xl font-mono text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-pink-600 hover:text-white hover:border-pink-600 transition-all shadow-sm"
              >
                Vedi Prodotto
                <svg
                  className="w-3 h-3"
